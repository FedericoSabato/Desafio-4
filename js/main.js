...
//Creo los objetos
let btc = new crypto("Bitcoin","$BTC",54128.93);
let eth = new crypto("Ethereum","$ETH",4140.45);
let ada = new crypto("Cardano","$ADA",1.63);
let sol = new crypto("Solana","$SOL",197.81);
let shiba = new crypto("Shiba INU","$SHIBA",0.00004);
